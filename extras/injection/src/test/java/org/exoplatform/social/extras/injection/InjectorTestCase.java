...
public class InjectorTestCase extends AbstractKernelTest {
  ...
  private void performMembershipTest(String userPrefix, String spacePrefix) throws Exception {
    ...
    assertEquals(3, space5.getMembers().length);
    assertEquals(3, space6.getMembers().length);
    assertEquals(3, space7.getMembers().length);
    assertEquals(3, space8.getMembers().length);
    ...
    assertEquals(3, space5.getManagers().length);
    assertEquals(3, space6.getManagers().length);
    assertEquals(3, space7.getManagers().length);
    assertEquals(3, space8.getManagers().length);
